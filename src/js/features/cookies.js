...
export class CookieConsent {
    ...
    attachEvents() {
        const { acceptBtn, rejectBtn, customizeBtn, saveBtn, closeBtn, modal } = this.elements;
    ...
    openModal() {
        ...
        // Set checkbox states
        if (preferences) {
            if (checkboxes.analytics) checkboxes.analytics.checked = preferences.analytics;
            if (checkboxes.marketing) checkboxes.marketing.checked = preferences.marketing;
            if (checkboxes.functional) checkboxes.functional.checked = preferences.functional;
        }
