...
class App {
    ...
    initTypewriter() {
        ...
        const type = () => {
            ...
            const delay = charIndex === currentPhrase.length ? 2000 :
                charIndex === 0 ? 500 :
                    isDeleting ? 30 : 50;
    ...
    initScrollAnimations() {
        ...
        observe('.text-reveal, .text-slide, .text-reveal-letter', 'revealed', { threshold: 0.3 });
    }
    ...
    initForm() {
        ...
        on(form, 'submit', async (e) => {
            ...
            // Validate
            if (!isRequired(data.name) || !isValidEmail(data.email) || !isValidPhone(data.whatsapp)) {
